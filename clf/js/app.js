...
function popup_close(item, bodyUnlock = true) {
	if (unlock) {
		...
		if(item.classList.contains('popup_main-video')) {
			let mainVideoItem = document.querySelector('.main-video__item');
		mainVideoItem.pause();
		}
	}
}
...
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".menu-mainblock__body");
...
//========================================================================================================================================================
let menuParents = document.querySelectorAll('.menu__active');
...
//========================================================================================================================================================
let videoHomePlay = document.querySelector('.header-mainblock__icon');
if (videoHomePlay) {
